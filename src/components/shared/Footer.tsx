...
const Footer = () => {
  ...
  return (
    <div
      className={`pt-10 px-4 sm:px-8 lg:px-12 ${
        theme === "dark" ? "bg-[#050709] text-white" : "bg-[#F6F3FC] text-black"
      }`}
    >
      <div className=" w-full sm:w-[40rem] md:w-[44rem] lg:w-[60rem] xl:w-[75rem] mx-auto flex flex-col md:flex-row justify-center mb-8">
        {/* About Section */}
