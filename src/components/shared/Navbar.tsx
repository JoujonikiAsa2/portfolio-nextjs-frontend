  ...
  return (
    ...
    >
      <div className="px-4 sm:px-8 lg:px-12 h-[5rem] w-full sm:w-[40rem] md:w-[48rem] lg:w-[64rem] xl:w-[80rem] mx-auto flex justify-between items-center">
        ...
        <div>
          <ul
            className={`navbar-links ${roboto.className} font-normal ${
        ...
        <div className="flex md:gap-8 lg:gap-0">
          ...
          <div className="sm:ml-2 md:ml-6 lg:ml-3 flex gap-2">
            <div className="navbar-menu block lg:hidden">
              <Button
            ...
            <div className={`${screenWidth <= 300 ? "hidden" : "block"}`}>
              {theme === "dark" ? (
                ...
                <Button
                  ...
                  className={` ${
                    theme === "dark" ? "" : "text-orange-400 border bg-white"
                  }`}
                >
                  <LucideLightbulb />
                </Button>
